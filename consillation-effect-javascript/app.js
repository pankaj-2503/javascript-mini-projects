...
function handleParticle(){
    for(let i=0;i<particleArray.length;i++){
        ...
        for(let j=i;j<particleArray.length;j++){
            ...
            if(distance<100){
                ctx.beginPath();
                ctx.strokeStyle=particleArray[i].color; //we can do different variety of pattern by commenting and uncommenting
...
function animate(){
  //below these two function can create different patterns by uncommenting and by commentingreate different patt
